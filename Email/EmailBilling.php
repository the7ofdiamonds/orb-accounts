...
class EmailBilling
{
    ...
    public function __construct($stripeClient)
    {
        ...
        $this->header = ORB_ACCOUNTS . 'Templates/TemplatesEmailBillingHeader.php';
        $this->body = ORB_ACCOUNTS . 'Templates/TemplatesEmailBillingBody.php';
        $this->footer = ORB_ACCOUNTS . 'Templates/TemplatesEmailBillingFooter.php';
    }
