"use strict";
(globalThis["webpackChunkorb_accounts"] = globalThis["webpackChunkorb_accounts"] || []).push([["src_views_BillingQuote_jsx"],{
...
function QuoteComponent() {
        ...
        if (response.error !== undefined) {
          ...
          dispatch((0,_controllers_accountsQuoteSlice_js__WEBPACK_IMPORTED_MODULE_3__.getQuoteByID)(id, response.payload.stripe_customer_id)).then(response => {
            if (response.error !== undefined) {
              ...
              dispatch((0,_controllers_accountsStripeSlice_js__WEBPACK_IMPORTED_MODULE_5__.getStripeQuote)(response.payload.stripe_quote_id)).then(response => {
                if (response.error !== undefined) {
                  console.error(response.error.message);
                  setMessageType('error');
                  setMessage(response.error.message);
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("section", {
    ...
    style: 'currency',
    currency: 'USD'
  }).format(item.cost)))))))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_StatusBar_jsx__WEBPACK_IMPORTED_MODULE_8__["default"], {
    message: message,
