...
const getStripeQuote = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createAsyncThunk)('quote/getStripeQuote', async (stripeQuoteID, {
  getState
}) => {
  const {
    stripe_quote_id
...
const updateStripeQuote = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createAsyncThunk)('quote/updateStripeQuote', async (_, {
  getState
}) => {
  const {
    stripe_quote_id,
...
const getStripeClientQuotes = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createAsyncThunk)('quote/getStripeClientQuotes', async (_, {
  getState
}) => {
  const {
    stripe_customer_id
...
const getPaymentMethod = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__.createAsyncThunk)('receipt/getPaymentMethod', async payment_method_id => {
  try {
...
const postReceipt = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__.createAsyncThunk)('receipt/postReceipt', async (_, {
  getState
}) => {
  const {
    stripe_customer_id,
...
const store = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_9__.configureStore)({
  reducer: {
    ...
    services: _controllers_accountsServicesSlice_js__WEBPACK_IMPORTED_MODULE_3__.accountsServicesSlice.reducer,
    quote: _controllers_accountsQuoteSlice_js__WEBPACK_IMPORTED_MODULE_4__.accountsQuoteSlice.reducer,
    invoice: _controllers_accountsInvoiceSlice_js__WEBPACK_IMPORTED_MODULE_5__.accountsInvoiceSlice.reducer,
    payment: _controllers_accountsPaymentSlice_js__WEBPACK_IMPORTED_MODULE_6__.accountsPaymentSlice.reducer,
    receipt: _controllers_accountsReceiptSlice_js__WEBPACK_IMPORTED_MODULE_7__.accountsReceiptSlice.reducer,
    schedule: _controllers_accountsScheduleSlice_js__WEBPACK_IMPORTED_MODULE_8__.accountsScheduleSlice.reducer
  }
});
