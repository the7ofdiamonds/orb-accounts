...
const accountsInvoiceSlice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createSlice)({
  ...
  extraReducers: builder => {
    builder.addCase(saveInvoice.fulfilled, (state, action) => {
      ...
      state.status = action.payload.status;
      state.invoiceError = null;
    }).addMatcher((0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.isAnyOf)(saveInvoice.pending, getInvoice.pending, getInvoiceByID.pending, getStripeInvoice.pending, updateInvoice.pending, updateInvoiceStatus.pending, getClientInvoices.pending, finalizeInvoice.pending), state => {
      state.invoiceLoading = true;
      state.invoiceError = null;
    }).addMatcher((0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.isAnyOf)(saveInvoice.rejected, getInvoice.rejected, getInvoiceByID.rejected, getStripeInvoice.rejected, updateInvoice.rejected, updateInvoiceStatus.rejected, getClientInvoices.rejected, finalizeInvoice.rejected), (state, action) => {
      state.invoiceLoading = false;
...
const accountsQuoteSlice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createSlice)({
  ...
  extraReducers: builder => {
    builder.addCase(createQuote.fulfilled, (state, action) => {
      ...
      state.quoteError = '';
      state.status = action.payload;
    }).addMatcher((0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.isAnyOf)(createQuote.pending, getQuote.pending, getQuoteByID.pending, getStripeQuote.pending, updateQuote.pending, updateQuoteStatus.pending, getClientQuotes.pending, getStripeClientQuotes.pending, finalizeQuote.pending, acceptQuote.pending, cancelQuote.pending), state => {
      state.quoteLoading = true;
      state.quoteError = null;
    }).addMatcher((0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.isAnyOf)(createQuote.rejected, getQuote.rejected, getQuoteByID.rejected, getStripeQuote.rejected, updateQuote.rejected, updateQuoteStatus.rejected, getClientQuotes.rejected, getStripeClientQuotes.rejected, finalizeQuote.rejected, acceptQuote.rejected, cancelQuote.rejected), (state, action) => {
      state.quoteLoading = false;
