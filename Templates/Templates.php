...
class Templates
{
    ...
    {
        $template = ORB_ACCOUNTS . 'Pages/page.php';;
    ...
    {
        $template = ORB_ACCOUNTS . 'Pages/page-protected.php';
    ...
    function get_archive_page_template($archive_template)
    {
        foreach ($this->post_types as $post_type) {
            ...
            if (is_post_type_archive($post_type['name'])) {
                $archive_template = ORB_ACCOUNTS . 'Post_Types/' . $post_type['plural'] . '/archive-' . $post_type['name'] . '.php';
    ...
    function get_single_page_template($single_template)
    {
        foreach ($this->post_types as $post_type) {
            ...
            if (is_singular($post_type['name'])) {
                $single_template = ORB_ACCOUNTS . 'Post_Types/' . $post_type['plural'] . '/single-' . $post_type['name'] . '.php';
