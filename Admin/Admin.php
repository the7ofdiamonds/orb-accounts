...
class Admin
{
    ...
    {
        include ORB_ACCOUNTS . 'Admin/includes/admin.php';
    }
    ...
    {
        $envFilePath = ORB_ACCOUNTS . 'serviceAccount.json';
...
<?php }
    ...
    {
        wp_enqueue_style('orb-admin-styles', ORB_ACCOUNTS_URL . 'Admin/CSS/Admin.css');
    }
}
